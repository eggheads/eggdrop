...
#define HALFOP_CANTDOMODE(_a)                                                  \
  (!me_op(chan) && (!me_halfop(chan) || (strchr(NOHALFOPS_MODES, _a) != NULL)))
#define HALFOP_CANDOMODE(_a)                                                   \
  (me_op(chan) || (me_halfop(chan) && (strchr(NOHALFOPS_MODES, _a) == NULL)))
...
#define channel_hidden(chan)                                                   \
  (chan->channel.mode & (CHANPRIV | CHANSEC))                  /* +s or +p ? */
