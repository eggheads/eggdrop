...
static void write_debug()
{
  ...
  if (nested_debug) {
    ...
    if (x >= 0) {
      ...
      dprintf(-x, "after a visit to https://github.com/eggheads/eggdrop/issues\n");
#ifdef EGG_PATCH
 ...
 */
  ...
  egg_snprintf(version, sizeof version,
               "Eggdrop v%s+%s (C) 1997 Robey Pointer (C) 2010-2023 Eggheads",
  ...
  egg_snprintf(version, sizeof version,
               "Eggdrop v%s (C) 1997 Robey Pointer (C) 2010-2023 Eggheads",
                EGG_STRINGVER);
#endif
