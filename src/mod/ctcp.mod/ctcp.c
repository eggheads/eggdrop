...
static int ctcp_FINGER(char *nick, char *uhost, char *handle, char *object,
...
static int ctcp_ECHOERR(char *nick, char *uhost, char *handle, char *object,
                        char *keyword, char *text) {
...
static int ctcp_PING(char *nick, char *uhost, char *handle, char *object,
                     char *keyword, char *text) {
...
static int ctcp_VERSION(char *nick, char *uhost, char *handle, char *object,
                        char *keyword, char *text) {
...
static int ctcp_USERINFO(char *nick, char *uhost, char *handle, char *object,
                         char *keyword, char *text) {
...
static int ctcp_CLIENTINFO(char *nick, char *uhosr, char *handle, char *object,
...
static cmd_t myctcp[] = {{"FINGER", "", ctcp_FINGER, NULL},
...
static tcl_strings mystrings[] = {{"ctcp-version", ctcp_version, 120, 0},
...
static Function ctcp_table[] = {
    (Function)ctcp_start, (Function)ctcp_close, (Function)NULL, (Function)NULL,
};
