...
/* 0 - 3 */
#define nmalloc(x)                                                             \
  (((void *(*)())global[0])((x), MODULE_NAME, __FILE__, __LINE__))
...
/* 8 - 11 */
#define add_bind_table                                                         \
  ((p_tcl_bind_list(*)(const char *, int, IntFunc))global[8])
#define del_bind_table ((void (*)(p_tcl_bind_list))global[9])
#define find_bind_table ((p_tcl_bind_list(*)(const char *))global[10])
#define check_tcl_bind                                                         \
  ((int (*)(p_tcl_bind_list, const char *, struct flag_record *, const char *, \
            int))global[11])
/* 12 - 15 */
...
#define botnet_send_zapf_broad                                                 \
  ((void (*)(int, char *, char *, char *))global[25])
...
#define botnet_send_filereject                                                 \
  ((void (*)(int, char *, char *, char *))global[29])
...
#define user_malloc(x)                                                         \
  ((void *(*)(int, char *, int))global[39])(x, __FILE__, __LINE__)
/* 40 - 43 */
#define get_user                                                               \
  ((void *(*)(struct user_entry_type *, struct userrec *))global[40])
#define set_user                                                               \
  ((int (*)(struct user_entry_type *, struct userrec *, void *))global[41])
#define add_entry_type ((int (*)(struct user_entry_type *))global[42])
#define del_entry_type ((int (*)(struct user_entry_type *))global[43])
/* 44 - 47 */
#define get_user_flagrec                                                       \
  ((void (*)(struct userrec *, struct flag_record *, const char *))global[44])
#define set_user_flagrec                                                       \
  ((void (*)(struct userrec *, struct flag_record *, const char *))global[45])
#define get_user_by_host ((struct userrec * (*)(char *)) global[46])
#define get_user_by_handle                                                     \
  ((struct userrec * (*)(struct userrec *, char *)) global[47])
/* 48 - 51 */
#define find_entry_type ((struct user_entry_type * (*)(char *)) global[48])
#define find_user_entry                                                        \
  ((struct user_entry * (*)(struct user_entry_type *, struct userrec *))       \
       global[49])
#define adduser                                                                \
  ((struct userrec * (*)(struct userrec *, char *, char *, char *, int))       \
       global[50])
...
/* 64 - 67 */
#define break_down_flags                                                       \
  ((void (*)(const char *, struct flag_record *,                               \
             struct flag_record *))global[64])
#define build_flags                                                            \
  ((void (*)(char *, struct flag_record *, struct flag_record *))global[65])
#define flagrec_eq                                                             \
  ((int (*)(struct flag_record *, struct flag_record *))global[66])
#define flagrec_ok                                                             \
  ((int (*)(struct flag_record *, struct flag_record *))global[67])
/* 68 - 71 */
...
#define egg_list_delete                                                        \
  ((int (*)(struct list_type **, struct list_type *))global[73])
#define egg_list_append                                                        \
  ((int (*)(struct list_type **, struct list_type *))global[74])
#define egg_list_contains                                                      \
  ((int (*)(struct list_type *, struct list_type *))global[75])
/* 76 - 79 */
...
#define get_data_ptr(x)                                                        \
  ((void *(*)(int, char *, int))global[86])(x, __FILE__, __LINE__)
...
#define xtra_unpack                                                            \
  ((void (*)(struct userrec *, struct user_entry *))global[145])
...
#define showhelp                                                               \
  ((void (*)(char *, char *, struct flag_record *, int))global[157])
...
#define add_mode                                                               \
  ((void (*)(struct chanset_t *, char, char, char *))(                         \
      *(Function **)(global[161])))
...
#define detect_dcc_flood                                                       \
  ((int (*)(time_t *, struct chat_info *, int))global[166])
...
#define botnet_send_chan                                                       \
  ((void (*)(int, char *, char *, int, char *))global[198])
...
/* 208 - 211 */
#define check_dcc_chanattrs                                                    \
  ((int (*)(struct userrec *, char *, int, int))global[208])
...
#define check_tcl_chjn                                                         \
  ((void (*)(const char *, const char *, int, char, int,                       \
             const char *))global[213])
...
#define rfc_ncasecmp                                                           \
  ((int (*)(char *, char *, int *))(*(Function **)(global[219])))
/* 220 - 223 */
...
#define user_realloc(x, y)                                                     \
  ((void *(*)(void *, int, char *, int))global[229])((x), (y), __FILE__,       \
                                                     __LINE__)
#define nrealloc(x, y)                                                         \
  (((void *(*)())global[230])((x), (y), MODULE_NAME, __FILE__, __LINE__))
#define xtra_set                                                               \
  ((int (*)(struct userrec *, struct user_entry *, void *))global[231])
/* 232 - 235 */
#ifdef DEBUG_CONTEXT
...
#define hostsanitycheck_dcc                                                    \
  ((int (*)(char *, char *, sockname_t *, char *, char *))global[239])
/* 240 - 243 */
...
#define egg_inet_aton                                                          \
  ((int (*)(const char *cp, struct in_addr *addr))global[251])
/* 252 - 255 */
#define egg_snprintf (global[252])
#define egg_vsnprintf                                                          \
  ((int (*)(char *, size_t, const char *, va_list))global[253])
#define egg_memset ((void *(*)(void *, int, size_t))global[254])
#define egg_strcasecmp ((int (*)(const char *, const char *))global[255])
/* 256 - 259 */
#define egg_strncasecmp                                                        \
  ((int (*)(const char *, const char *, size_t))global[256])
...
#define str_escape                                                             \
  ((char *(*)(const char *, const char, const char))global[262])
#define strchr_unescape                                                        \
  ((char *(*)(char *, const char, register const char))global[263])
/* 264 - 267 */
#define str_unescape ((void (*)(char *, register const char))global[264])
#define egg_strcatn                                                            \
  ((int (*)(char *dst, const char *src, size_t max))global[265])
...
#define getdccfamilyaddr                                                       \
  ((int (*)(sockname_t *, char *, socklen_t, int))global[302])
