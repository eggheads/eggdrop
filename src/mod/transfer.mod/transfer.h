...
#define raw_dcc_send(a, b, c)                                                  \
  (((int (*)(char *, char *, char *))transfer_funcs[9])(a, b, c))
#define show_queued_files(a) (((void (*)(int))transfer_funcs[10])(a))
#define wild_match_file(a, b)                                                  \
  (((int (*)(register char *, register char *))transfer_funcs[11])(a, b))
/* 12 - 15 */
...
#define raw_dcc_resend(a, b, c)                                                \
  (((int (*)(char *, char *, char *))transfer_funcs[18])(a, b, c))
