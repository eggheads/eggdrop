...
^^^
  ...
  The latest Eggdrop stable source code is always located at `<https://geteggdrop.com>`_. You can also download the current stable, previous stable, and development snapshot at `<ftp.eggheads.org/pub/eggdrop/source>`_
