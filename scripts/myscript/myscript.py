...
binds.join.add(callback=joinGreetUser, flags=FlagMatcher(), mask="*")
binds.join.add(callback=joinGreetOp, flags=FlagMatcher(globalflags=perm.op | perm.master | perm.owner, chanflags=perm.o | perm.m | perm.n), mask="*")
binds.pubm.add(callback=mypub, flags=FlagMatcher(), mask="*")
pprint(binds.all())
