...
# stuff for Tcl
XREQ = /usr/local/lib/libtcl81.so.1
TCLLIB = /usr/local/lib
CFLAGS = -c -g -O2 -I.. -DHAVE_CONFIG_H ${CFLGS}
...
'STRIP=${MOD_STRIP}' 'CFLAGS=${CFLAGS} -DSTATIC' 'XLIBS=-L/usr/local/lib -ltcl81 -lm '
...
'XLIBS=-L/usr/local/lib -ltcl81 -lm '
